...
class Complex_Field extends Field {
	...
	/**
	 * Propmapperse hierarchy to child fields
	 */
	...
	/**
	 * Set the datastore of this field and propmapperse it to children
	 *
	...
	/**
	 * Propmapperse the datastore down the hierarchy
	 *
	 * @param Datastore_Interface $datastore
	 * @param boolean             $set_as_default
	 */
	...
	public function get_formatted_value() {
		...
		foreach ( $field_groups as $group_index => $field_group ) {
			...
			foreach ( $field_group as $key => $field ) {
				...
				} elseif ( $key === Value_Set::VALUE_PROPERTY ) {
